#Name: Brian Williams
# Prog Purpose: This program compute grades for students using a
#      Python list of data in python DICTIONARYS (As student records)
#      Each student has 3 graded items: homework, Midterm exam, And final exam.
#      Each item is worth 100 points
#      The students final grade is the average of the tree graded items.
