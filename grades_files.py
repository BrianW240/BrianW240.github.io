#Name: Brian Williams
# Prog Purpose: This program reads a comma-delamited data file into a LIST of smaller lists.
#   The data for each student is appended to a lis with six data fields:
...
def create_report_file():
    ...
    repfile.write(line)
    repfile.close()
    print("Open this file to view the Grades Repost: " + out_file)
