# Name: Brian Williams
# Prog Purpose: This program demonstrates how to manipulate a list, including: Finding number of items in the list,
# Sorting the list, Adding/ removing items, Copying a list of items into another list, And Changing the data in the list.
...
def main():
    ...
    print("\nRemove a dog by name rather then position in the list:")
    print(dogs)
